const messages = {
  ...
  empty: {
    library: {
      title: "你的 Clips 從這裡開始",
      body: "錄製螢幕、攝影機或兩者。你的 Clip 會在這裡準備好，方便檢視和分享。",
      cta: "錄製一個 Clip",
    },
    shared: {
      title: "查看與您共用的錄製",
    ...
    folder: {
      title: "將這項工作集中起來",
      body: "將相關錄製移入此資料夾，或為這個專案錄製新的 Clip。",
      cta: "錄製一個 Clip",
    },
    space: {
      title: "為這個空間新增第一個 Clip",
      body: "在這裡錄製或移動一個 Clip，讓團隊在同一個地方找到它。",
      cta: "錄製一個 Clip",
    },
    archive: {
      title: "尚無封存的錄製",
      body: "封存的 Clips 會保存在這裡，直到你準備好將它們恢復。",
    },
    trash: {
      title: "廢紙簍是空的",
      body: "刪除的 Clips 會在這裡保留 30 天，然後永久移除。",
    },
    search: {
      title: "沒有內容符合這次搜尋",
      body: "嘗試其他關鍵字，或清除篩選條件來找到你要的 Clip。",
    },
  },
  trashRoute: {
    title: "廢紙簍",
  ...
  recordingPage: {
    ...
    tags: "標籤",
    addTag: "新增標籤…",
    tagsUpdateFailed: "無法更新標籤",
    tagTooLong: "標籤最多 {{max}} 個字元",
  ...
  dictateRoute: {
    ...
    browserDictationDescription: "邊說邊記錄想法。複製轉錄文字，或用 AI 潤飾。",
    ...
    cleaned: "已清理",
    delete: "刪除",
    deleteDictationTitle: "要刪除這則聽寫嗎？",
    deleteDictationDescription: "這會從您的歷史記錄中永久移除這則聽寫。",
    deleted: "聽寫已刪除",
    deleteFailed: "無法刪除聽寫",
    showDetails: "詳細資料",
    info: "聽寫資訊",
    ...
    cleanupComplete: "聽寫已清理",
    cleanupFailed: "無法清理聽寫",
    startFirst: "把想法變成文字",
    recordOnDesktop: "在桌面版錄製",
  ...
  meetingsRoute: {
    ...
    title: "會議",
    intro:
      "在會議期間透過 Clips Desktop 開始記錄筆記。轉錄文字和筆記會儲存在這裡。",
    searchPlaceholder: "搜尋會議、與會者和逐字稿...",
    agendaTab: "議程",
    pastTab: "過往",
    now: "現在",
    noPastMeetings: "您的會議記錄從這裡開始",
    loadOlder: "載入較舊的",
    searchFailed: "無法搜尋會議。請稍後再試。",
    clearSearch: "清除搜尋",
    noMeetingsYet: "目前沒有安排",
    noMeetingsDescription: "已連結日曆中的近期活動安排好後，會顯示在這裡。",
