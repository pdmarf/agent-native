const messages = {
  ...
  redaction: {
    ...
    goTo: "跳转到此处遮挡",
    helpDraw:
      "在画面上拖动。方框覆盖接下来的 10 秒；松开时按住 Shift 可改为覆盖整个所选片段。",
    helpDrawTerm: "遮住内容",
    helpFollow:
  ...
  recordingPage: {
    ...
    tags: "标签",
    addTag: "添加标签…",
    tagsUpdateFailed: "无法更新标签",
    tagTooLong: "标签最多 {{max}} 个字符",
  ...
  dictateRoute: {
    ...
    cleaned: "已清理",
    delete: "删除",
    deleteDictationTitle: "删除这条听写？",
    deleteDictationDescription: "这会从听写历史中永久删除该内容。",
    deleted: "听写已删除",
    deleteFailed: "删除听写失败",
    showDetails: "详细信息",
    info: "听写信息",
